...
controller.down.onEvent(ControllerButtonEvent.Pressed, function () {
    if (controller.up.isPressed() && controller.A.isPressed()) {
        game.splash("Shadow clone jujistu")
        for (let index = 0; index < 4; index++) {
            mySprite = sprites.create(img`
                ...
                . . . . . f f f f f f . . . . . 
                . . . . . f f . . f f . . . . . 
                `, SpriteKind.Fake_player)
            if (tiles.tileAtLocationEquals(mySprite.tilemapLocation(), sprites.castle.tilePath5)) {
                tiles.placeOnRandomTile(mySprite, sprites.castle.tilePath5)
            } else if (tiles.tileAtLocationEquals(mySprite.tilemapLocation(), sprites.castle.saplingOak)) {
                ...
                tiles.placeOnRandomTile(mySprite, sprites.castle.saplingOak)
            } else if (tiles.tileAtLocationEquals(mySprite.tilemapLocation(), sprites.castle.saplingPine)) {
                tiles.placeOnRandomTile(mySprite, sprites.castle.saplingPine)
            }
        }
    }
    pause(10000)
    sprites.destroyAllSpritesOfKind(SpriteKind.Fake_player)
})
